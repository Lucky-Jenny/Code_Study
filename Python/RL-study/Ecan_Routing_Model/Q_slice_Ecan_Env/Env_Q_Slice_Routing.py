...
class QSliceRoutingEnv:
    ...
    def start_slice_routing(self, task_space, router_space, q_table):
        ...
        for t in range(self.time_limit):  # 时隙
            ...
            for r in reversed(self.R_list):
                ...
                # print('    Q[', r, ']:', self.Router_Task_Index_Queue[r], self.Router_Task_Data_Queue[r], end=' ')
                ...
                while fwd_buff > 0:
                    ...
                    if any(task_space[s][0]) is False and task_space[s][2] == 0:
                        task_space[s][2] = 1
                        task_mark += 1
                        # print('\ntask[', s, '] is finished !!! total_finish=', task_mark, '\n------------')
    ...
    def select_action(self, r_id, q_array, t_state):
        """
    ...
    def generate_q_table_while_routing(self, task_space, router_space, q_table):
        ...
        for t in range(self.time_limit):  # 时隙
            ...
            for s in range(self.T_len):
                ...
                # 根据奖励，更新Q表
                # print('updt(', self.Task_List[s], ') q-tb:', s, ':', task_space[s][1], end=' ')
