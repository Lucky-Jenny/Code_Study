...
from Model_local_q_1path import MAPLocal
...
for t_size in range(T_size_start, T_size_end, T_len):
    ...
    env_route = Q1PathRoutingEnv(mp, Task_List)
    '迭代更新Q表'
    ...
    env_route.generate_path_from_q_table(Q, Task_Space)
    print(env_route.Task_Path)
    times, stk_prob, jl = env_route.start_slice_routing(Task_Space, Router_Space, Q)
