...
class SpfSliceRoutingEnv:
    ...
    def start_slice_routing_in_spf(self, task_space, router_space):
        """
        分片路由
        :param task_space:
        :param router_space:
        ...
        for t in range(self.time_limit):
            ...
            # 逆序遍历，防止自传递
            for r in reversed(self.short_path):
                # 队列为空
                ...
                while fwd_buff > 0:
                    ...
                    # 执行路由
                    ps_new, state_new, fwd_buff = self.do_route_spf(s, r, fwd_buff, task_space[s], router_space)
